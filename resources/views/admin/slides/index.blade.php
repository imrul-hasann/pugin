            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="text-right">
                        <a href="#" class="btn btn-info" id="btn-create">Add Slides</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="dropify" name="photo_url">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function get_rj(){
        $.get('{{ route('get_slides.ajax') }}', {_token:'{{ csrf_token() }}'}, function(data){
    ...
    $(function () {
        ...
        $("#btn-create").on("click", function (e) {
            ...
            $("#head_text").html('Add Slides');

            $(".dropify-preview").removeAttr('style');

            var form = $("#form-create");
            form.attr("action", route('slides.store'));
