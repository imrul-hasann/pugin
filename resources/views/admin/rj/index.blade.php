            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="text-right">
                        <a href="#" class="btn btn-info" id="btn-create">Add RJ</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-wrapper">
                            <div class="form-group">
                                <label class="form-label">RJ Name</label>
...
<script>
    ...
    function get_rj(){
        $.get('{{ route('get_rj.ajax') }}', {_token:'{{ csrf_token() }}'}, function(data){
    ...
    $(function () {
        ...
        $("#btn-create").on("click", function (e) {
            ...
            $("#head_text").html('Add RJ');

            $(".dropify-preview").removeAttr('style');
            var form = $("#form-create");
            form.attr("action", route('rj.store'));
    ...
    function deleteRj(e,id){
        // console.log(id);
        if (confirm("Delete this item?")) {
            $.ajax({
                url: route('rj.destroy', id) ,
                method: "DELETE",
